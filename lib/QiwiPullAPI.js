...
module.exports = class QiwiPullAPI {
     ...
     */
    redirectUrlBuilder({shop = this._prvId, transaction, iframe = false, successUrl = '', failUrl = '', target, pay_source}) {

        const url = 'https://bill.qiwi.com/order/external/main.action';
